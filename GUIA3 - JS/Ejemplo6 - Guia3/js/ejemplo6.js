//Todo el modulo se encuentra dentro de una funcion
//conocida como funcion inmediata, en este caso
//tambien anónima que provoca que todo se ejecute
//de una vez
(function(){
    ...
    //al presionar el botón denominado botonTirar y 
    //obtener todos los elementos img presentes en el 
    //documento
    function iniciar(){
    ...
    function establecerImagen(imgDado){
        ...
        //Estableciendo el atribtuo src de la imagen
