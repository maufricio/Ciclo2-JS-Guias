function inicializar(){
    ...
    var i, max, temp, contenido="", tdelement, k;
    var mensaje, msgModo;
    ...
    msgModo = prompt("Ingresa el modo que quieres que sean ordenados tus numeros. a. Ascendente  b. Descendente", "");
    
    if(msgModo === "ascendente"){
        with(document){
